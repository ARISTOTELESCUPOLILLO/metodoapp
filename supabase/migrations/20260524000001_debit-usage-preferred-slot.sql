-- Adiciona _preferred_slot ao debit_usage.
-- Quando informado, o RPC tenta esse slot primeiro e faz fallback para os demais.
-- Módulo PU passa 'plano2' para garantir que o consumo vai para o plano Post Único.
