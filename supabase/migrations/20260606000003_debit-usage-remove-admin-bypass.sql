-- Admins passam pelas mesmas verificações de limite que usuários comuns.
-- Remove o bloco "IF v_admin THEN ... RETURN 'admin'" que deixava admins
-- debitar sem checar prazo, imagens, renders ou gerações.
