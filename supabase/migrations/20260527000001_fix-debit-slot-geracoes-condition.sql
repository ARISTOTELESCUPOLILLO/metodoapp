-- Corrige condição do debit_usage: slots com geracoes_limite=0 (plano sem rastreio de gerações)
-- estavam bloqueando débitos de imagens e renders após geracoes_usadas > 0.
-- Regra: se a coluna _X_limite = 0, o slot não rastreia esse recurso → não bloquear.
