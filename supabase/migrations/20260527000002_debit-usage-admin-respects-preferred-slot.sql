-- Corrige admin bypass: antes sempre debitava em plano1 independente do _preferred_slot.
-- Agora respeita o slot preferido: PU (plano2), bônus ou MOP (plano1 default).
...
BEGIN
  ...
  IF v_admin THEN
    IF _preferred_slot = 'plano2' THEN
      UPDATE public.profiles
       ...
       WHERE id = _user_id;
    ELSIF _preferred_slot = 'bonus' THEN
      UPDATE public.profiles
