    ...
    <header className="sticky top-0 z-30 backdrop-blur-md bg-[#0a1326]/80 border-b border-white/5">
      <div className="max-w-7xl mx-auto px-5 md:px-8 h-16 md:h-20 flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-white/80">
          <a href="#topo" className="hover:text-white transition-colors">Home</a>
          <a href="#diferenciais" className="hover:text-white transition-colors">Como funciona</a>
          <a href="#faq" className="hover:text-white transition-colors">FAQ</a>
          <Link to="/login" className="hover:text-white transition-colors">Login</Link>
        </nav>

        <div className="hidden lg:flex items-center gap-4 text-xs text-white/60">
          <a href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 hover:text-white">
      ...
      <div className="max-w-5xl mx-auto px-5 md:px-8 -mt-2 md:-mt-10 pb-16 md:pb-24 relative z-10">
        <div className="text-center">
          ...
          <p className="mt-5 md:mt-7 text-base md:text-lg text-white/75 max-w-3xl mx-auto leading-relaxed">
            O Método OP organiza a produção de conteúdo para empresas através de soluções textuais
            e visuais alinhadas ao marketing digital, ajudando marcas a criarem presença com mais
  ...
  return (
    <section className="relative py-20 md:py-28 border-t border-white/5">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-60"
        style={{
          background:
            'radial-gradient(circle at 50% 30%, rgba(245,166,35,0.10), transparent 55%)',
        }}
      />
      <div className="relative max-w-4xl mx-auto px-5 md:px-8 text-center">
        ...
        <p className="mt-6 md:mt-8 text-base md:text-lg text-white/75 max-w-2xl mx-auto leading-relaxed">
          O Método OP ajuda empresas a manterem sua presença digital ativa sem transformar a
          criação de conteúdo em um desgaste diário.
        </p>
        <div className="mt-10">
          <a
            href={WHATSAPP_URL}
    ...
    <footer className="border-t border-white/5 bg-[#070e1d]">
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-white/75">
              <li>
                <a href={WHATSAPP_URL} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 hover:text-[#f5a623]">
                  <MessageCircle size={14} /> +55 66 99988-1627
                </a>
              </li>
              <li>
                <a href={`mailto:${EMAIL}`} className="inline-flex items-center gap-2 hover:text-[#f5a623]">
                  <Mail size={14} /> {EMAIL}
                </a>
              </li>
              <li>
                <a href="https://instagram.com/opropagandabr" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 hover:text-[#f5a623]">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-white/75">
              ...
              <li><Link to="/exclusao-de-dados" className="hover:text-[#f5a623]">Exclusão de Dados</Link></li>
              <li>
                <button
                  type="button"
        ...
        <div className="mt-10 pt-6 border-t border-white/5 text-xs text-white/40 text-center">
          © {new Date().getFullYear()} Oficina de Propaganda · CNPJ: 03.834.539/0001-34 · Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
...
function CookiesContent({ onReviewPreferences }: { onReviewPreferences: () => void }) {
  return (
    <>
      <p>
        Esta Política explica como o <strong>Método OP</strong> usa cookies e tecnologias
        similares para fazer o aplicativo funcionar e melhorar sua experiência.
      </p>

      <LegalH3>1. O que são cookies</LegalH3>
      <p>
        Cookies são pequenos arquivos armazenados no seu navegador que permitem reconhecer
        seu acesso, lembrar preferências e medir o uso do serviço.
      </p>

      <LegalH3>2. Tipos de cookies que usamos</LegalH3>
      <ul className="list-disc pl-5 space-y-1.5">
        <li>
          <strong>Necessários</strong> (sempre ativos): essenciais para a sessão de login e
        ...
        <li>
          <strong>Analíticos</strong> (opcionais, só com consentimento): métricas agregadas
          de uso para ajudar a evoluir o produto.
        </li>
      </ul>

      <LegalH3>3. Como gerenciar</LegalH3>
      <p>
        Use os botões "Aceitar todos" ou "Apenas necessários" no banner de consentimento.
        Você também pode limpar cookies pelas configurações do seu navegador a qualquer
        momento.
      </p>
      <div>
        <button
      ...
      <p>
        Provedores de infraestrutura em nuvem podem definir cookies estritamente
        ...
        <div className="flex items-start gap-3 mb-3">
          ...
          <div>
            ...
            <p className="text-xs md:text-sm text-white/70 leading-relaxed">
              Usamos cookies para fazer o app funcionar e melhorar sua experiência. Você
              pode aceitar todos ou só os necessários.
            </p>
          </div>
        </div>
