  ...
  head: () => ({
    meta: [
      { title: "Política de Privacidade — Método OP" },
      {
        name: "description",
        content:
          "Como a Oficina de Propaganda trata os dados pessoais dos usuários do Método OP, em conformidade com a LGPD.",
      },
    ],
  }),
      ...
      <main className="max-w-3xl mx-auto px-5 py-12 md:py-16">
        ...
        <div className="text-[15px] leading-relaxed text-white/80 space-y-4">
          <p>
            ...
            dados pessoais coletados, em conformidade com a Lei Geral de Proteção de Dados (Lei nº
            13.709/2018 — LGPD).
          </p>
          ...
          <H3>3. Finalidades</H3>
          <p>
            Operar o aplicativo, autenticar acesso, gerar conteúdo personalizado, melhorar o serviço
          ...
          <p>
            ...
            inteligência artificial usados para gerar conteúdo, sempre sob contrato e estritamente
            para viabilizar o serviço. <strong>Nunca vendemos seus dados.</strong>
          </p>

          <H3>6. Armazenamento e segurança</H3>
          <p>
            Os dados ficam em servidores em nuvem com criptografia em trânsito (HTTPS) e controles
            de acesso. Aplicamos boas práticas de segurança para reduzir riscos.
          </p>
          ...
          <p>
            ...
            ou pelas configurações do navegador.
          </p>
