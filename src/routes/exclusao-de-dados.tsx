...
export const Route = createFileRoute('/exclusao-de-dados')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Saiba como solicitar a exclusão dos seus dados pessoais do aplicativo Método OP, da Oficina de Propaganda.' },
    ],
  }),
      ...
      <main className="max-w-3xl mx-auto px-5 py-12 md:py-16">
        ...
        <div className="text-[15px] leading-relaxed text-white/80 space-y-4">
          ...
          <p>
            ...
            <a href={`mailto:${EMAIL}?subject=Solicitação de exclusão de dados — Método OP`} className="text-[#f5a623] hover:underline">
              {EMAIL}
            </a>{' '}
            com o assunto <strong>"Solicitação de exclusão de dados — Método OP"</strong> e
            inclua:
          </p>
          <ul className="list-disc pl-5 space-y-1.5">
          ...
          <div className="space-y-3">
            {[
              ...
              { step: '2', text: 'Verificamos a identidade do solicitante para garantir a segurança da exclusão.' },
              { step: '3', text: 'Excluímos ou anonimizamos todos os dados pessoais associados à conta em até 15 dias úteis.' },
          ...
          <p>
            Alguns dados podem ser mantidos por prazo adicional quando houver obrigação legal
            (ex.: registros fiscais e contábeis exigidos por lei) ou para defesa em processos
            judiciais ou administrativos em andamento. Nesses casos, informamos o motivo e o
            prazo de retenção na resposta à solicitação.
          </p>

          <H3>Exclusão de dados provenientes da Meta</H3>
          <p>
            Se você usou o login via Meta (Facebook/Instagram) para acessar o Método OP,
            o processo de exclusão acima remove todos os dados coletados por nosso aplicativo.
            Para revogar as permissões concedidas ao app na plataforma Meta, acesse:{' '}
            <a
      ...
      <footer className="border-t border-white/5 py-8 mt-12">
        <div className="max-w-3xl mx-auto px-5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/30">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link to="/exclusao-de-dados" className="hover:text-white/60 transition-colors">Exclusão de Dados</Link>
          </div>
        </div>
      </footer>
    </div>
