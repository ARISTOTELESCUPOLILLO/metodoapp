...
function pctOf(u: number, l: number) {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div
            style={{ fontSize: 11, color: "#64748b", textTransform: "uppercase", fontWeight: 600 }}
          >
            {slot.label}
          </div>
        ...
        <div style={{ fontSize: 12, color: "#64748b", textAlign: "right" }}>
          início
          <br />
          <strong style={{ color: "#0f172a" }}>{fmtDate(slot.inicio)}</strong>
        </div>
      </header>
...
function ContaPage() {
  ...
  return (
    <div
      style={{ maxWidth: 900, margin: "0 auto", padding: "20px 14px", display: "grid", gap: 20 }}
    >
      <header>
        <div
          style={{
        ...
        {profile.segmento && (
          ...
          >
            ...
            <span style={{ fontSize: 11, opacity: 0.8 }}>
              · orienta a personalização das imagens
            </span>
          </div>
        )}
      </header>
