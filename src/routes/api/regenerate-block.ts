...
⚠ COMPOR, NÃO TRANSCREVER: os dados são o MATERIAL da manchete, nunca a frase pronta. PROIBIDO devolver a informação-chave na mesma ordem e com as mesmas palavras acrescentando um fecho no fim ou uma chamada no começo — trocar o fecho por outro ("aproveite hoje", "chegou agora", "confira já") não resolve: o defeito é a transcrição, não a palavra colada. PROIBIDO TAMBÉM apenas embaralhar os mesmos elementos com um adjetivo a mais: continua a mesma frase de vitrine.
⚠ O TÍTULO PRECISA AFIRMAR ALGO: tem VERBO e diz alguma coisa sobre a oferta? Nomear o produto e pendurar o preço ao lado é etiqueta, não manchete. Obrigatórios são item, preço, prazo e condição — público-alvo, adjetivos e complementos da informação-chave podem ficar de fora para a frase caber. Ex. com "Óleo lubrificante 20W50 por R$ 39,90": ✗ "Seu óleo 20W50 novo por R$ 39,90" (etiqueta) — ✓ "R$ 39,90 no óleo que seu motor pede" (afirma, com verbo).
