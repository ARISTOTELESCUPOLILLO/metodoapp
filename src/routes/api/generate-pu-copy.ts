...
- ⚠ COMPOR, NÃO TRANSCREVER — REGRA QUE DECIDE ESTE TÍTULO: os dados acima são o MATERIAL da manchete, nunca a frase pronta. PROIBIDO devolver a informação-chave na mesma ordem e com as mesmas palavras acrescentando um fecho no fim ou uma chamada no começo — trocar o fecho por outro ("aproveite hoje", "chegou agora", "confira já", "não perca") não resolve nada: o defeito é a transcrição, não a palavra colada. Escreva uma frase SUA que CARREGUE os dados obrigatórios: mude a ordem dos elementos, o sujeito ou a construção. Ex.: informação-chave "Óleo lubrificante 20W50 por R$ 39,90" → ✗ "Óleo lubrificante 20W50 por R$ 39,90 confira" (é a frase do usuário com uma palavra colada) → ✓ "R$ 39,90 no óleo que seu motor pede" (mesmos dados, frase composta).
