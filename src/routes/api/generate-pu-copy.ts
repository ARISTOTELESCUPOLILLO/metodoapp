...
- REGRA DE URGÊNCIA NO TÍTULO (só para "titulo", não para "texto"): PROIBIDO urgência temporal clichê — "hoje", "agora", "já", "última chance", "corra" (e variações), em qualquer objetivo. O título expressa valor, produto ou contexto favorável — nunca depende de urgência.`;
