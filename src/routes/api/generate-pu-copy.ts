...
{
  "titulo": "título curto, no MÁXIMO 6 palavras, cada palavra com no máximo 3 sílabas (exceto o substantivo concreto central da informação-chave, se houver), impactante, em português brasileiro",
...
Regras:
- "titulo" no máximo 6 palavras, cada palavra com no máximo 3 sílabas (ex.: "negócio" 3 sílabas ✓, "resultado" 4 sílabas ✗ — use "ganho", "retorno"), sem ponto final, sem aspas, sem emoji, sem hashtag. EXCEÇÃO AO LIMITE DE SÍLABAS: se a informação-chave contém um substantivo concreto central (produto, peça, serviço, objeto ou procedimento — ex.: "equipamento", "manutenção", "lubrificante", "orçamento", "diagnóstico", "estratégia"), esse termo pode ultrapassar 3 sílabas quando for essencial para a clareza do título — não o troque por uma palavra genérica só para encurtar. EXCEÇÃO OBRIGATÓRIA: se o título for uma pergunta (direta ou retórica), terminar com "?" — NUNCA omitir. Ex.: "Por que é assim?" ✓, "O que está faltando?" ✓
...
- SUJEITO DO TÍTULO — LIBERDADE GRAMATICAL: qualquer classe gramatical pode exercer função de sujeito quando substantivada — substantivo (concreto ou abstrato), adjetivo, verbo no infinitivo, advérbio, pronome ou locução (ex.: "Cuidar bem...", "A escolha certa...", "Quem decide...", "Pronto para..."). O título NÃO precisa repetir a estrutura "[item] + [complemento]" da informação-chave — pode assumir outra construção, desde que a ANCORAGEM CONCRETA — PRESERVAÇÃO DO ELEMENTO abaixo seja respeitada. PROIBIDA construção passiva sem agente (ex.: "Entrega sem atraso garantida"). ATENÇÃO — sujeito abstrato + predicado abstrato vira frase vazia: se o sujeito escolhido for abstrato ou um verbo no infinitivo substantivado (ex.: "Responder...", "Cuidar...", "A escolha..."), o predicado NÃO pode ser "faz/traz/gera/vira/se torna/transforma [outro abstrato]" (ex.: "Responder faz diferença de verdade" ✗ — nada para fotografar). Troque por ação, agente ou elemento concreto observável (ex.: "Responder rápido resolve o dia do cliente" ✓).
