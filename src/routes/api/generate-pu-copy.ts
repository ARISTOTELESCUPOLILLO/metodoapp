...
- ANCORAGEM CONCRETA — ANTI-SÍMBOLO: o título deve poder virar uma FOTO de pessoa(s) real(is) em ação observável (decidir, atender, revisar, fechar, apresentar, entregar). Teste antes de retornar: "dá para fotografar isso sem recorrer a objeto-metáfora?" Se a única imagem possível for engrenagem, peão de madeira, seta, xadrez, escada, mosquetão, corda, troféu ou aperto de mãos → título conceitual demais; reescreva com verbo de ação + agente. Prefira "Time alinhado fecha mais" a "Equipe forte traz bom ganho". PADRÕES PROIBIDOS: "[abstrato] traz [resultado]", "[abstrato] é [abstrato]", "[abstrato] gera [resultado]", "[abstrato] vira [resultado]", "[abstrato] se torna [resultado]", "[abstrato] transforma [resultado]".
