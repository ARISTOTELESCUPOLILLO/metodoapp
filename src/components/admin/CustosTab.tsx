...
export function CustosTab() {
  ...
  const planRows = activePlans.map(p => {
    ...
    return { planId: p.id, codigo: p.codigo, nome: p.nome, usuarios: users.length, custoRealUsd: custoReal, projecaoUsd: projecao, precoMin, precoMed, precoMax, margemMin, margemMax };
