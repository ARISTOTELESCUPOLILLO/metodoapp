    ...
    <div style={{ display: "grid", gap: 10 }}>
      ...
      {hasRegular && (
        <div style={{ display: "grid", gap: 6 }}>
          ...
          {igState === "err" && (
            <p style={{ margin: 0, fontSize: 12, color: "#b91c1c" }}>Instagram: {igError}</p>
          )}
          {fbState === "err" && (
            <p style={{ margin: 0, fontSize: 12, color: "#b91c1c" }}>Facebook: {fbError}</p>
          )}
        </div>
      )}
      ...
      {status.devMode && (
        <div style={{ display: "grid", gap: 8 }}>
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              ...
              {bothIgState === "err" && (
                <p style={{ margin: 0, fontSize: 12, color: "#b91c1c" }}>
                  Instagram: {bothIgError}
                </p>
              )}
              {bothFbState === "err" && (
                <p style={{ margin: 0, fontSize: 12, color: "#b91c1c" }}>Facebook: {bothFbError}</p>
              )}
            </div>
          ) : (
            <button
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            {igTestState === "ok" ? (
              ...
              <button
                ...
                style={{
                  ...primaryBtn(igTestState === "loading"),
                  background: "linear-gradient(135deg,#833AB4,#C13584,#E1306C,#FD1D1D)",
                  color: "#fff",
                }}
              >
            ...
            {fbTestState === "ok" ? (
              ...
              <button
                ...
                style={{
                  ...primaryBtn(fbTestState === "loading"),
                  background: "#1877F2",
                  color: "#fff",
                }}
              >
          ...
          {igTestState === "err" && (
            <p style={{ margin: 0, fontSize: 12, color: "#b91c1c" }}>Instagram: {igTestError}</p>
          )}
          {fbTestState === "err" && (
            <p style={{ margin: 0, fontSize: 12, color: "#b91c1c" }}>Facebook: {fbTestError}</p>
          )}
        </div>
      )}
    </div>
