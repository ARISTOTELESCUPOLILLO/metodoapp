      ...
      <header style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div
          style={{
            ...
            borderRadius: 8,
            background:
              "linear-gradient(135deg,#405DE6,#5851DB,#833AB4,#C13584,#E1306C,#FD1D1D,#F56040,#F77737,#FCAF45)",
            display: "flex",
            alignItems: "center",
      ...
      {status?.connected ? (
            ...
            {status.token_expires_at && (
              <div style={{ fontSize: 11, color: status.expired ? "#dc2626" : "#94a3b8" }}>
                {status.expired
                  ...
                  : `Token válido até ${new Date(status.token_expires_at).toLocaleDateString("pt-BR")}`}
              </div>
            )}
          </div>
        ...
        <>
          <p style={{ margin: 0, fontSize: 13, color: "#64748b", lineHeight: 1.5 }}>
            Conecte sua conta Meta para publicar imagens e legendas diretamente no Instagram e
            Facebook após gerar a peça.
          </p>
          <button
            type="button"
            onClick={disabled ? undefined : handleConnect}
