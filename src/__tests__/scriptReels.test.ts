...
describe("validateScriptReels — o que passa", () => {
  const BOM =
    "Seu site recebe cliques todo dia, e quase nenhum deles vira uma conversa de verdade com quem atende o cliente. O numero sozinho nao sustenta.";
...
describe("o exemplo do prompt obedece a própria régua", () => {
  const EXEMPLO =
    "Seu site recebe cliques todo dia, e quase nenhum deles vira uma conversa de verdade com quem atende o cliente. O número sozinho não sustenta.";
...
describe("o trilho do texto de apoio nao serve ao roteiro", () => {
  ...
  const ROTEIRO_CERTO =
    "Quem lidera produto novo ja busca apoio antes, e nao so na hora de divulgar o que o time criou. O proximo passo e calibrar juntos.";
