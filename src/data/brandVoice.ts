...
export const voiceProfiles: Record<string, VoiceProfile> = {
  ...
  Consultiva: {
    ...
    vocabulario:
      "Termos técnicos do setor sempre acompanhados de tradução prática. Sem jargão de palco.",
    registro:
      "Analítico, ponderado, sem dramatizar. Voz de especialista que escuta antes de opinar.",
  ...
  Acolhedora: {
    ...
    vocabulario:
      "Palavras simples, próximas do cotidiano do cliente. Pronomes em primeira pessoa do plural quando couber.",
  ...
  Técnica: {
    ...
    vocabulario:
      "Termos técnicos precisos, sem simplificação artificial. Números preferíveis a adjetivos.",
  ...
  Calorosa: {
    ...
    vocabulario:
      'Palavras sensoriais e afetivas. Verbos de aproximação ("chega", "cabe", "fica bem").',
  ...
  Autoral: {
    ...
    exemploAbertura:
      "A gente desenhou esta linha pensando em quem cansou de coleção sem ponto de vista.",
  },
  Inspiradora: {
    label: "Inspiradora",
    ...
    exemploAbertura:
      "Existe um jeito de fazer isto que ainda não virou regra. É deste lado que a gente trabalha.",
  },
  Sofisticada: {
    label: "Sofisticada",
