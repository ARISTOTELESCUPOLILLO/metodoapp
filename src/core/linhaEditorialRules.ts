...
- ⚠ TESTE DOS DOIS TÍTULOS — FAÇA ANTES DE RESPONDER: escreva o título de ABERTURA e o de FECHAMENTO um debaixo do outro e confira duas coisas. (a) Eles COMEÇAM com a mesma palavra? (b) Têm a MESMA forma, com só o verbo trocado? Se a resposta for sim para qualquer uma, você NÃO diferenciou — reescreva um dos dois. Ex. do que NÃO serve: "${item} guia a rota" / "${item} decide o resultado" — mesmo sujeito, mesma forma, só o verbo mudou; é a mesma frase disfarçada. O que serve: um dos dois muda o SUJEITO e mantém o nome em OUTRA posição da frase — ex.: "${item} guia a rota" / "Quem começa pelo ${item} erra menos".
