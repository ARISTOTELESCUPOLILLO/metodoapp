...
Permitir apenas quando estiver explicitamente ligado à informação-chave, ao segmento ou à natureza real do negócio — e desde que não contrarie a gramática do mood.`
  ...
  const moodRules: Partial<Record<MoodCode, string>> = {
    ...
    'OP-04':
      ...
      'OBJETO PERMITIDO NESTE MOOD: notebook ou laptop FECHADO, de lado, de costas ou com tela apagada/escura pode aparecer como UM dos blocos quando coerente com o ofício (trabalho de escritório, planejamento, atendimento) — seguindo sempre a regra geral de dispositivos digitais (sem tela visível, sem conteúdo, máximo 1 por cena). ' +
