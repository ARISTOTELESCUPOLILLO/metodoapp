...
const MOOD_RULES: Partial<Record<MoodCode, string>> = {
  ...
  'OP-03':
    ...
    'PROIBIDO ESPECÍFICO — METÁFORA DO TÍTULO NÃO VIRA CENA LITERAL: palavras do título com sentido estratégico ou metafórico ("rumo", "caminho", "direção", "passo", "virada", "sentido", "movimento") NUNCA devem ser traduzidas como cena física de deslocamento — pessoa andando, saindo pela porta, caminhando com pasta, personagem de costas indo embora, corredor ou porta como elemento principal. O que define a cena é o que a empresa CONCRETAMENTE FAZ, derivado do texto de apoio, da atividade real e da informação-chave, não da leitura literal de uma palavra do título. Para empresas de serviço: quando o texto mencionar campanha, estratégia, orientação, decisão, clientes ou melhoria de ações, preferir cenas de análise de material, conversa de orientação, revisão de peças ou provas de arte, briefing ou planejamento prático, profissional ajudando cliente em momento de decisão — cenas que mostram o serviço entregue, não movimentação genérica. ' +
