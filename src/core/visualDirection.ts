...
- A TAMPA TRASEIRA / VERSO / CARCAÇA do dispositivo é uma superfície SÓLIDA e OPACA, sem display. Proibido renderizar ali qualquer interface, gráfico, dashboard, ícone, app, brilho de tela, reflexo de UI, segunda tela, logo de sistema operacional ou "vazamento" de conteúdo da tela frontal. A tampa nunca repete a tela.
- ENQUADRAMENTO OBRIGATÓRIO: o aparelho deve aparecer em ângulo que naturalmente esconda ou minimize a tampa traseira — sobre a mesa visto em perfil/diagonal, na mão em uso, no colo, câmera baixa rente à superfície, por cima do ombro de quem digita. Proibido: vista top-down de laptop fechado, foto frontal do verso de tablet/celular como elemento central, mockup plano da tampa.
