...
- TAMPA / VERSO / CARCAÇA — DEFEITO FÍSICO PROIBIDO: a tampa traseira do notebook e o verso de qualquer dispositivo são superfícies físicas SÓLIDAS e OPACAS (plástico, alumínio, couro). NÃO têm tela. NÃO emitem luz. NÃO exibem conteúdo. PROIBIDO ABSOLUTAMENTE: brilho de tela ou emissão luminosa na tampa; imagem, interface, dashboard, ícone ou qualquer conteúdo visual sobre a tampa; duplicação ou espelho da tela frontal na carcaça traseira; efeito "tela invertida" na tampa; aparência de monitor dos dois lados; qualquer elemento emissivo simulando display no verso. A tampa PODE aparecer parcialmente na cena — o que NUNCA pode existir é conteúdo visual aplicado sobre ela. COMPORTAMENTO FÍSICO CORRETO: tampa sólida e neutra, tela exclusivamente na face interna, dispositivo fisicamente coerente e realista.
- ENQUADRAMENTO OBRIGATÓRIO: câmera posicionada FRONTALMENTE À TELA — perfil/diagonal sobre a mesa, na mão em uso, no colo, câmera rente à superfície. A imagePrompt DEVE especificar "câmera frontal à tela" ou equivalente. PROIBIDO: câmera posicionada atrás do aparelho, top-down de laptop fechado, foto frontal do verso como elemento central, mockup plano da tampa.
