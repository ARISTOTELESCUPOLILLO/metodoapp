...
- SUJEITO DO TÍTULO: proibido fazer da dúvida, do problema ou da dificuldade o único sujeito do título sem âncora no público ou na oportunidade — o protagonista deve ser o público, a ação ou a saída, não a dificuldade sozinha. Ex. proibido: "Dúvidas no contrato surgem" → correto: "Gestores fecham com clareza" ou "Confiança antes de assinar".
- TEXTO DE APOIO — PADRÕES PROIBIDOS: "vendas aumentadas", "resultados mais consistentes", "crescimento constante e", "para seu negócio", "para a sua empresa", "para a sua marca". Proibido o padrão "[ação] gera [resultado]" ou "[ação] faz [resultado]" repetido — preferir construções diretas: sujeito + verbo principal + complemento específico.
