...
- Roteiro falado (campo "script") — ISTO É FALA, NÃO TEXTO. Será lido em voz alta por sintetizador e o vídeo dura o que a fala durar. Escreva ouvindo, não lendo.
  ⚠ OS PRIMEIROS SEGUNDOS DECIDEM SE A PESSOA FICA. Levantamento dos roteiros que este sistema produziu: 4 em 5 começavam por subordinada ou verbo no infinitivo ("Quando a escolha…", "Buscar apoio…", "Só repetir passo…") e só entregavam a ideia por volta da décima palavra. Quem está passando o dedo já foi embora. ABRA PELA AFIRMAÇÃO: a primeira coisa dita já é a ideia, não a condição que a precede. PROIBIDO começar o script por "Quando", "Se", "Ao", "Caso", "Enquanto", "Embora", "Como", "Porque", nem por verbo no infinitivo. Isto NÃO é fórmula de viralizar: é a MESMA frase, começando pelo que importa.
  ⚠ FALE COM UMA PESSOA — SEGUNDA PESSOA, e só aqui: no roteiro falado do Reels, dirija-se a QUEM ASSISTE ("seu site", "você", "sua equipe") em vez de falar sobre terceiros ("quem lidera", "o time", "as empresas"). Vídeo é conversa, e conversa tem interlocutor. ⚠ ISTO NÃO REVOGA A PROIBIÇÃO DE CRITICAR O LEITOR: falar COM a pessoa é o oposto de julgá-la — nada de "você está perdendo dinheiro", "você faz errado", "seu problema é". E vale SOMENTE para o campo "script": título, texto de apoio, cards e legenda seguem como sempre foram.
  ⚠ A FALA CONTINUA A CAPA, NÃO A REPETE: o "hook" acima vai escrito na capa do vídeo, e quem assiste LÊ o hook e OUVE o script. Repetir o hook com outras palavras desperdiça os primeiros segundos; trocar de assunto faz parecer duas peças coladas. O script AVANÇA a ideia do hook — se o hook faz a pergunta, o script responde; se o hook afirma, o script mostra a consequência.
  ESTRUTURA — EXATAMENTE 2 partes, separadas por PONTO FINAL:
  (1) MENSAGEM — ${SCRIPT_MENSAGEM_MIN_WORDS} a ${SCRIPT_MENSAGEM_MAX_WORDS} palavras, com PELO MENOS UMA VÍRGULA no ponto natural de respiro. A vírgula NÃO é enfeite de escrita: é onde a voz PAUSA. Sem ela o sintetizador atravessa a frase inteira sem ar e a locução sai apressada. ⚠ ANTES DESSA VÍRGULA TEM DE HAVER UMA AFIRMAÇÃO QUE SE SUSTENTA SOZINHA (no mínimo ${SCRIPT_ABERTURA_MIN_WORDS} palavras): pôr um advérbio solto na frente para "cumprir a vírgula" é o atalho que já saiu daqui — "Agora, quem lidera produto novo…" faz a pessoa ouvir um "agora" e continuar sem saber do que se trata.
  ...
  TOTAL: ${SCRIPT_MIN_WORDS} a ${SCRIPT_MAX_WORDS} palavras → cerca de 10 segundos de locução.
...
- REGRA TTS — campo "script" (será LIDO em voz alta por sintetizador): USE palavras de 1 ou 2 sílabas sempre que possível. ⚠ EXCEÇÃO ÚNICA, E ELA VENCE ESTE LIMITE: o NOME DO PRODUTO escolhido pelo usuário não tem teto de sílabas aqui. A regra abaixo proíbe mais de 3 sílabas e o nome cadastrado costuma ter 5 ou mais ("consultoria", "diagnóstico", "contabilidade") — as duas exigências se contradiziam e o modelo decidia sozinha qual obedecer. O nome, quando entrar no script, entra inteiro ou no seu núcleo comercial; PROIBIDO trocá-lo por sinônimo mais curto. Fora o nome do produto, PROIBIDO: palavras com mais de 3 sílabas, siglas em caixa alta (APP→"app", CRM→"sistema", ROI→"retorno", KPI→"meta", IA→"inteligência"), anglicismos crus (link, lead, brief, deadline, framework), abreviações (vc, tb, p/). TRADUZA termos difíceis: "consultoria"→"apoio"; "estratégia"→"plano"; "posicionamento"→"presença". Exemplo correto (28 palavras, MENSAGEM com vírgula de respiro + FECHO curto que encerra): "Seu site recebe cliques todo dia, e quase nenhum deles vira uma conversa de verdade com quem atende o seu cliente. O número sozinho não sustenta o dia." O campo "screenText" PODE conter sigla (é lido com os olhos), mas o "script" NÃO PODE — precisa fluir natural em voz alta em português brasileiro.
