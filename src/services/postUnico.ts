...
const OBJETIVO_VISUAL_EXCLUSIONS: Record<Exclude<PostUnicoObjetivo, 'nenhum'>, string> = {
  ...
  oportunidade: 'PROIBIDO ABSOLUTO: porta entreaberta com feixe de luz dourada, portal luminoso, arco com luz, luz no fim do túnel, pôr do sol como metáfora, corredor de concreto, pessoa correndo, lâmpada isolada como símbolo de ideia, seta apontando para cima como símbolo de crescimento, Post-it com ícones de negócios (gráfico, alvo, carrinho, pessoas). Esses elementos são clichês motivacionais e corporativos banidos — não aparecem mesmo que o briefing não os cite. NEGATIVE: glowing doorway, door with light, lightbulb, upward arrow, post-it with business icons, running person.',
